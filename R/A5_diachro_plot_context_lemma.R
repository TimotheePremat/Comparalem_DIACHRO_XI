...
POS_context_count_lemma <- POS_context %>% count(cat,id, !!sym(my_lemma))
...
#-------
POS_E_C_lemma_count <- POS_E_C_cleaned %>% count(id, !!sym(my_lemma)) %>%
                      rename(n.E = n)
POS_nonE_C_lemma_count <- POS_nonE_C_cleaned %>% count(id, !!sym(my_lemma)) %>%
                      rename(n.nonE = n)
...
geom_point(aes(shape=!!sym(my_lemma), color=!!sym(my_lemma))) +
...
#-------
POS_E_V_lemma_count <- POS_E_V_cleaned %>% count(id, !!sym(my_lemma)) %>%
                 rename(n.E = n)
POS_nonE_V_lemma_count <- POS_nonE_V_cleaned %>% count(id, !!sym(my_lemma))  %>%
                 rename(n.nonE = n)
