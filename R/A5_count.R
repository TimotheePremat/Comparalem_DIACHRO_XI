...
POS_lemma <- POS %>% group_by(!!sym(my_lemma))
POS_lemma <- POS_lemma %>% count(!!sym(my_lemma), sort=TRUE) #First time gets the number of occ. per lemma
POS_lemma <- POS_lemma %>% count(!!sym(my_lemma), sort=TRUE) #Second time get 1 by lemma
...
POS_var_lemma <- POS_var %>% group_by(!!sym(my_lemma))
POS_var_lemma <- POS_var_lemma %>% count(!!sym(my_lemma), sort=TRUE) #First time gets the number of occ. per lemma
POS_var_lemma <- POS_var_lemma %>% count(!!sym(my_lemma), sort=TRUE) #Second time get 1 by lemma
